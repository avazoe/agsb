...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "avazoe"         # 用户名
UUID = "bb6de853-1057-4c89-8689-d3512b85cdc4"                     # UUID，留空则自动生成
PORT = 49999                # Vmess端口，留空或0则自动生成
DOMAIN = "avazoe.top"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiNjdhYTM0N2ZkZmUwNDA0NDMzZWQ1OWYyMzAxYmY1ZTkiLCJ0IjoiYWRiNDMxYjYtOWMyNy00OTlkLTlhZWQtMjcwMGQxZTNkM2JhIiwicyI6Ik1USm1OVGhoWldFdE1qZzJNQzAwTXpOaExXSTROell0WkRGbE16RmtOMk5qT1RjeCJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
